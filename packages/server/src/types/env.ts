...
export interface Bindings {
  ...
  WENYAN_CONSENSUS_ALLOW_SINGLE_REPLICA?: string
  WENYAN_CONSENSUS_PUBLIC_KEYS_JSON?: string
  WENYAN_CONSENSUS_PRIVATE_KEYS_JSON?: string
  ...
  WENYAN_AUTH_JWT_ALG?: "HS256" | "EdDSA"
  WENYAN_AUTH_JWT_SECRET?: string
  WENYAN_AUTH_JWT_PUBLIC_KEYS_JSON?: string
